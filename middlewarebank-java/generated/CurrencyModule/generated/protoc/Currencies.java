...
/**
 * Protobuf type {@code curr.Currencies}
 */
public final class Currencies extends
        com.google.protobuf.GeneratedMessageV3 implements
        // @@protoc_insertion_point(message_implements:curr.Currencies)
        CurrenciesOrBuilder {
    ...
    getDescriptor() {
        return CurrencyProto.internal_static_curr_Currencies_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    internalGetFieldAccessorTable() {
        return CurrencyProto.internal_static_curr_Currencies_fieldAccessorTable
                .ensureFieldAccessorsInitialized(
                        Currencies.class, Currencies.Builder.class);
    }

    public static final int CURRENCIES_FIELD_NUMBER = 1;
    private java.util.List<java.lang.Integer> currencies_;
    private static final com.google.protobuf.Internal.ListAdapter.Converter<
            java.lang.Integer, Currency> currencies_converter_ =
            new com.google.protobuf.Internal.ListAdapter.Converter<
                    java.lang.Integer, Currency>() {
                public Currency convert(java.lang.Integer from) {
    ...
    public java.util.List<Currency> getCurrenciesList() {
        return new com.google.protobuf.Internal.ListAdapter<
                java.lang.Integer, Currency>(currencies_, currencies_converter_);
    }
    ...
    public static Currencies parseFrom(
    ...
    public static Currencies parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
    }
    ...
    public static Currencies parseFrom(java.io.InputStream input)
            throws java.io.IOException {
    ...
    public static Currencies parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
                .parseDelimitedWithIOException(PARSER, input);
    }

    public static Currencies parseDelimitedFrom(
            java.io.InputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(Currencies prototype) {
    ...
    public static final class Builder extends
            ...
            // @@protoc_insertion_point(builder_implements:curr.Currencies)
            CurrenciesOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
            return CurrencyProto.internal_static_curr_Currencies_descriptor;
        ...
        // Construct using  Currencies.newBuilder()
        private Builder() {
        ...
        public Currencies getDefaultInstanceForType() {
            return Currencies.getDefaultInstance();
        }

        public Currencies build() {
            Currencies result = buildPartial();
        ...
        public Currencies buildPartial() {
            Currencies result = new Currencies(this);
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
            if (other instanceof Currencies) {
                return mergeFrom((Currencies) other);
            } else {
        ...
        public Builder mergeFrom(Currencies other) {
            if (other == Currencies.getDefaultInstance()) return this;
        ...
        public Builder mergeFrom(
                ...
                com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                throws java.io.IOException {
            Currencies parsedMessage = null;
            try {
                parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
            } catch (com.google.protobuf.InvalidProtocolBufferException e) {
                parsedMessage = (Currencies) e.getUnfinishedMessage();
        ...
        public Builder addAllCurrencies(
                java.lang.Iterable<? extends Currency> values) {
            ensureCurrenciesIsMutable();
        ...
        // @@protoc_insertion_point(builder_scope:curr.Currencies)
    }

    // @@protoc_insertion_point(class_scope:curr.Currencies)
    private static final Currencies DEFAULT_INSTANCE;

    static {
        DEFAULT_INSTANCE = new Currencies();
    }

    public static Currencies getDefaultInstance() {
